...
(function() {
  var Bot, RemoteBot, crypto, fs, request, tmpDir, util,
  ...
  exports.Bot = RemoteBot = (function(_super) {
    __extends(RemoteBot, _super);

    function RemoteBot(url, opts) {
      this.url = url;
      this.opts = opts;
      this.opts || (this.opts = {});
      if (this.opts.debug) {
    ...
    RemoteBot.prototype.setup = function(url, callback) {
      var _this = this;
      return request.get({
        url: url,
        json: true,
    ...
    RemoteBot.prototype.update = function(game, callback) {
      var result;
      result = 0;
      return request.post({
        url: this.url,
