  ...
  exports.start = function(config) {
    ...
    run = function() {
      ...
      game.on('roundStart', function() {
        return narrator != null ? typeof narrator.roundStart === "function" ? narrator.roundStart(game.status(Game.STATUS.PRIVILEGED)) : void 0 : void 0;
      });
      game.on('stateChange', function(state) {
        return narrator != null ? typeof narrator.stateChange === "function" ? narrator.stateChange(state, game.status(Game.STATUS.PRIVILEGED)) : void 0 : void 0;
      });
      ...
      game.on('complete', function(status) {
        var numPlayer;
        if (narrator != null) {
          if (typeof narrator.roundComplete === "function") {
    ...
    return async.until((function() {
      ...
      for (_j = 0, _len1 = bots.length; _j < _len1; _j++) {
        ...
        players.push(player);
        player.on('betAction', function(emittedPlayer, action, amount, err) {
          return narrator != null ? typeof narrator.playerBet === "function" ? narrator.playerBet(emittedPlayer, action, amount, err) : void 0 : void 0;
        });
      }
      return run();
    });
