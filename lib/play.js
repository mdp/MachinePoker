...
(function() {
  ...
  exports.start = function(config) {
    var betting, bots, chips, j, location, maxRounds, name, narrator, obsLocation, obsNotifier, observer, observers, players, run, _i, _len, _ref, _ref1, _ref2;
    observers = [];
    players = [];
    bots = [];
    narrator = null;
